...
import com.game.service.ValidateService;
...
public class PlayerController {
    ...
    private final ValidateService playerValidationService;

    @Autowired
    public PlayerController(PlayerService playerService, ValidateService playerValidationService) {
